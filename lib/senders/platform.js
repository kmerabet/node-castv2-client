...
PlatformSender.prototype.sendMessage = function(text, ID) { //*****************
  /*if(this.message == null) {
    //this.message = new MessageController(this.client, 'sender-0', ID);
  }
  //this.message.sendMessage(text);
  //console.log(this.receiver);
  var message = JSON.stringify({type: "MESSAGE", message: text});
  this.client.send('sender-12345', ID, 'urn:x-cast:com.sii.cast.messaging', message);*/
